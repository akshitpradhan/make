...
abstract class AllEvents
{
    ...
    public function onCodeRegister($mynumber, $status, $login, $type, $edgeRoutingInfo, $chatDNSDomain, $setSecurityCode)
    {
    }
    ...
    public function onCodeRequest($mynumber, $method, $length, $status, $retry_after, $sms_wait, $voice_wait)
    {
    }
    ...
    public function onGetAudio($audioObject)
    {
    }
    ...
    public function onGetDocument($documentObject)
    {
    }
    ...
    public function onGetGroupAudio($audioObject)
    {
    }

    public function onGetGroupImage($imageObject)
    {
    }

    public function onGetGroupLocation($locationObject)
    {
    }

    public function onGetGroupMessage($messageObject)
    {
    }
    ...
    public function onGetGroupVideo($videoObject)
    {
    }

    public function onGetGroupvCard($vcardObject)
    {
    }

    public function onGetImage($imageObject)
    {
    }

    public function onGetLocation($locationObject)
    {
    }

    public function onGetMessage($messgeObject)
    {
    }
    ...
    public function onGetVideo($videoObject)
    {
    }

    public function onGetvCard($vcardObject)
    {
    }
    ...
    public function onGroupsPictureChanged($mynumber, $from, $id, $time, $author)
    {
    }

    public function onGroupsPictureDeleted($mynumber, $from, $id, $time, $author)
    {
    }
