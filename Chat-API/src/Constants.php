...
class Constants
{
    ...
    const WHATSAPP_CHECK_HOST = 'https://v.whatsapp.net/v2/exist';          // The check credentials host.
    const WHATSAPP_GROUP_SERVER = 'g.us';                                   // The Group server hostname
    const WHATSAPP_REGISTER_HOST = 'https://v.whatsapp.net/v2/register';    // The register code host.
    const WHATSAPP_REQUEST_HOST = 'https://v.whatsapp.net/v2/code';         // The request code host.
    const WHATSAPP_SERVER = 's.whatsapp.net';                               // The hostname used to login/send messages.
    const SERVER_STATUS = 'https://www.whatsapp.com/status.php?v=2';        // WhatsApp's status host
    const WHATSAPP_VER = '2.19.15';                                        // The WhatsApp version.
